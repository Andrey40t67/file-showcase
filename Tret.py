...
def change_wallpaper():
    # Установите путь к изображению обоев
    wallpaper_path = os.path.join(os.getcwd(), '2024-07-30_17-14-43.png')
...
if __name__ == "__main__":
    if os.path.exists('reboot_flag.txt'):
        # Система перезагрузилась, выполняем изменения обоев и скрытие значков
        os.remove('reboot_flag.txt')
        change_wallpaper()
        hide_desktop_icons()
    else:
        # Первый запуск, создаем флаг
